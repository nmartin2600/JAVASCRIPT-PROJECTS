...
function placeXOrO(squareNumber) {
    ...
    // The .some() method is used to check each element of selectedSquares
...
function checkWinConditions() {
    ...
    // O 3, 4, 5 condition
    else if (arrayIncludes('3O','4O','2O')) { drawWinLine(50,304,558,304) }
    // O 6, 7, 8 condition
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        // Indicates where the start of a line's y axis is
        y1 = coordY1,
        // Indicates where the end of a line's x axis is
        x2 = coordX2,
        // Indicates where the end of a line's y axis is
        y2 = coordY2,
        // Stores temporary x axis data that we update in our animation loop
        x = x1,
        // Stores temporary y axis data that we update in our animation loop
        y = y1;
