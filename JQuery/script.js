$(document).ready(function() {
    // This function uses chaining technique to
    ...
    $("#classicCars").on({
        // Triggers the images to slide down one after another
        // when the user's mouse enters the area of div with id
        // #classicCars
        mouseenter: function() {
            $("#titleOne").show(1000);
            $("#titleTwo").show(1500);
        ...
        // Triggers images to slide up and hide each title
        // when the user's mouse leaves div area with id
        // #classicCars
        mouseleave: function() {
            $("#titleOne").hide(2000);
            $("#titleTwo").hide(1500);
    ...
    // each element's sibling so they don't all display when one
    // question is clicked
