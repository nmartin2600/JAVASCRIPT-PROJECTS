...
function subtractFromParagraph() {
    let para = document.getElementById("subtract");
...
function multiplyParagraph() {
    let para = document.getElementById("multiply");
    const product = 2 * 2;
...
function divideParagraph() {
    let para = document.getElementById("division");
    const quotient = 20 / 5;
...
function multiParagraph() {
    let para = document.getElementById("multiple");
...
function modulusParagraph() {
    let para = document.getElementById("modulus");
...
function negateParagraph() {
    let para = document.getElementById("negate");
    const operand = 10;
...
function roundParagraph() {
    let para = document.getElementById("round");
